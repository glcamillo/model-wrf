...
&io
 input_root_name = '$CAMINHO/wrfout_d0$DOMINIO$TRACO$INICIO_ANO-$INICIO_MES-$INICIO_DIA$TRACO$INICIO_HORA:00:00'
 output_root_name = '$CAMINHO/wrfout_d0$DOMINIO$TRACO$TIPO_NIVEL'
! plot = 'all_list'
 plot = 'all_list_file'
! plot = 'list'
! plot = 'file'
